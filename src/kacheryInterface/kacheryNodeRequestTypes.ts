...
export type KacheryNodeRequestBody =
    ReportRequestBody | GetNodeConfigRequestBody | GetBitwooderCertForChannelRequestBody | GetChannelConfigRequestBody

export const isKacheryNodeRequestBody = (x: any): x is KacheryNodeRequestBody => {
    return isOneOf([
        isReportRequestBody, isGetNodeConfigRequestBody, isGetBitwooderCertForChannelRequestBody, isGetChannelConfigRequestBody
    ])(x)
}
