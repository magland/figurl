import { CanvasDragEvent, CanvasWidgetLayer, ClickEvent, ClickEventType, funcToTransform, useLayer, useLayers } from 'figurl/labbox-react/components/CanvasWidget'
